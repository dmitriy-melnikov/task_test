module.exports = {
    "Testing Form" : function (browser) {
        browser
            .url('https://mail.ru', () => {
                console.log(`loading.. mail.ru`)
            })
            .waitForElementVisible('body', 5000)
            .execute(function () {
                console.log(`Hello my first test`)
                document.getElementById('search__categories').innerText = 'Hello my first test';
            })
            .getText('#text', result => {
                browser.assert.equal(result.innerText, 'Hello my first test');
            })
